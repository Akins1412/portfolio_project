...
class ShowTime(db.Model, BaseModel):
  ...
  movie = db.relationship('Movie', backref=db.backref('showtimes', lazy='dynamic'))
  theater = db.relationship('Theater', backref=db.backref('showtimes', lazy='dynamic'))
...
def Booking(db.Model, BaseModel):
  
  __tablename__ = "bookings"
  
  id = db.Coulomn(db.Integer, primary_key=True)
  ...
  showtime = db.relationship('ShowTime', backref=db.backref('bookings', lazy='dynamic'))
